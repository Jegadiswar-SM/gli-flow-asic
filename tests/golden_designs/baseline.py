...
UART = _register(DesignBaseline(
    name="uart",
    rtl_files=["uart.v", "uart_rx.v", "uart_tx.v", "baud_gen.v"],
    top_module="uart",
    pdk="sky130A",
...
FIR = _register(DesignBaseline(
    name="fir",
    rtl_files=["fir.v", "mac.v", "delay_line.v"],
    top_module="fir",
    pdk="sky130A",
...
SMALL_RISCV = _register(DesignBaseline(
    name="small_riscv",
    rtl_files=["core.v", "alu.v", "regfile.v", "ctrl.v", "mem_if.v"],
    top_module="small_riscv",
    pdk="sky130A",
    expected_qor_min=0.2,
    expected_wns_min=-5.0,
    expected_tns_min=-100.0,
    expected_util_max=70.0,
    expected_max_runtime_s=1800.0,
    expected_drc_clean=True,
    expected_lvs_clean=True,
    expected_setup_pass=True,
    expected_hold_pass=True,
